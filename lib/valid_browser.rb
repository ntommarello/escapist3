module ValidBrowser
  ...
  SupportedBrowsers = [
    Browser.new("Safari", "4.0.0"),
    Browser.new("Firefox", "4.0.0"),
    Browser.new("Internet Explorer", "9.0"),
    Browser.new("Opera", "9.27"),
    Browser.new("Chrome", "8.0"),
    Browser.new("Android", "3.1.2"),
    Browser.new("webOS", "1.0"),
    Browser.new("BlackBerry", "6.0.0.141"),
    Browser.new("Mozilla", "4.0")
  ]
