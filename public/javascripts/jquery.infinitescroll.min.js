...
;(function($){
  ...
  $.fn.infinitescroll = function(options,callback){
    ...
    function reset() {  //nt
        ...
        props.currPage = 1;
        props.loadingImg = undefined;
		props.loadingMsg = undefined;
		props.container = undefined;
		props.currDOMChunk = null;
		props.isDuringAjax = false;
        props.isDone = false;
		props.isInvalidPage = false;
    ...
    //nt
	$('.dropOption').bind('click', function() {
	  reset();
	});
	$('.ChallengeMenu').bind('click', function() {
	  reset();
	});
	$('.challenge_weather').bind('click', function() {
	  reset();
	});
	$( "#BudgetSlider" ).bind( "slidechange", function(event, ui) {
	  reset();
	});
	$( "#DiffSlider" ).bind( "slidechange", function(event, ui) {
	  reset();
	});
