...
Gem::Specification.new do |s|
  ...
  s.files = ["test/environment_test.rb", "test/generator_test.rb", "test/instance_test.rb", "test/test_helper.rb", "test/util_test.rb", "test/zerigo_test.rb", "bin/vulcanize"]
  ...
  s.test_files = ["test/environment_test.rb", "test/generator_test.rb", "test/instance_test.rb", "test/test_helper.rb", "test/util_test.rb", "test/zerigo_test.rb"]
